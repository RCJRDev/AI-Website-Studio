          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                className="p-2 -m-2 text-slate-300 hover:text-white transition-colors rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-electric-400"
            ...
            <ul className="mt-4 space-y-3" role="list">
              {footerNavigation.services.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-slate-300 hover:text-white transition-colors py-1 inline-block rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-electric-400"
                  >
                    {item.name}
                  </Link>
                </li>
